      ...
      <section id="contact" className="contact-band">
        <div className="container contact-grid">
          ...
          <div className="contact-card">
            ...
            <p>From the A283 Steyning Bypass, take the B2135 Ashurst to Partridge Green Road. The fishery is around 200 yards on the left, opposite Chanctonfold Industrial Estate.</p>
